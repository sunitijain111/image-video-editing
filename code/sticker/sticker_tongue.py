...
def detection(grayscale, img):
    ...
    for (x_face, y_face, w_face, h_face) in face:
        ...
        smile = cascade_smile.detectMultiScale(ri_grayscale, 1.7,40)
        ...
        for (x_smile, y_smile, w_smile, h_smile) in smile: 
            ...
            ri_color = img[y_face:img.shape[0], x_face:img.shape[1]] 
            ...
            ri_color[y_tongue: y_tongue+min_d, x_tongue: x_tongue+min_w] = dst
