...
def detection(grayscale, img):
    ...
    arrUpperBody = cascade_upper_body.detectMultiScale( grayscale, scaleFactor = 1.1, minNeighbors = 5, minSize = (50, 100),flags = cv2.CASCADE_SCALE_IMAGE   )
    y1,y2,x1,x2=0,0,0,0
    for (x,y,w,h) in arrUpperBody:
        ...
        tshirt= cv2.imread("tshirt2.png", -1)        
        #cv2.imshow("tshirt preview",img)
